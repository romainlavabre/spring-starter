package com.replace.replace.api.top.kernel.setter;

import com.replace.replace.api.request.Request;
import com.replace.replace.api.top.annotation.Constraint;
import com.replace.replace.api.top.annotation.RequestParameter;
import com.replace.replace.api.top.api.CustomConstraint;
import com.replace.replace.api.top.kernel.entity.EntityHandler;
import com.replace.replace.api.top.kernel.exception.InvalidSetterParameterType;
import com.replace.replace.api.top.kernel.exception.MultipleSetterFoundException;
import com.replace.replace.api.top.kernel.exception.SetterNotFoundException;
import com.replace.replace.api.top.kernel.exception.ToManySetterParameterException;
import com.replace.replace.api.top.kernel.util.Formatter;
import com.replace.replace.api.top.kernel.util.TypeResolver;
...
public class SetterHandler {
    ...
    public static class Setter {
        ...
        protected Method searchSetter()
            ...
            com.replace.replace.api.top.annotation.Setter setter = field.getAnnotation( com.replace.replace.api.top.annotation.Setter.class );

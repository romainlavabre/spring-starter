...
import com.replace.replace.api.top.annotation.CreateTrigger;
import com.replace.replace.api.top.annotation.DeleteTrigger;
import com.replace.replace.api.top.annotation.UnmanagedTrigger;
import com.replace.replace.api.top.annotation.UpdateTrigger;
...
public class Trigger {
    ...
    protected void handleCreateTrigger( Request request, TriggerHandler.Trigger targetTrigger, com.replace.replace.api.top.annotation.Trigger trigger, Object lastSubject )
            throws Throwable {
    ...
    protected void handleUpdateTrigger( Request request, TriggerHandler.Trigger targetTrigger, com.replace.replace.api.top.annotation.Trigger trigger, Object lastSubject )
            throws Throwable {
    ...
    protected void handleDeleteTrigger( Request request, TriggerHandler.Trigger targetTrigger, com.replace.replace.api.top.annotation.Trigger trigger, Object lastSubject )
            throws Throwable {
    ...
    protected void handleTriggers( Request request, List< com.replace.replace.api.top.annotation.Trigger > triggers, Object lastSubject ) throws Throwable {
        for ( com.replace.replace.api.top.annotation.Trigger trigger : triggers ) {

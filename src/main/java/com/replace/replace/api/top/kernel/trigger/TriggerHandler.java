package com.replace.replace.api.top.kernel.trigger;
...
import com.replace.replace.api.top.kernel.exception.*;
...
public class TriggerHandler {
    ...
    public class Trigger {
        ...
        private final List< com.replace.replace.api.top.annotation.Trigger > triggers;
        ...
        public List< com.replace.replace.api.top.annotation.Trigger > getTriggers() {
            return triggers;
        }

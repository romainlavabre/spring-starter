...
public class Create implements CreateEntry {
    ...
    protected void create( Request request, Object subject, List< SetterHandler.Setter > setters, List< com.replace.replace.api.top.annotation.Trigger > nextTriggers )
            throws Throwable {
    ...
    protected void create( Request request, Object subject, List< SetterHandler.Setter > setters, List< com.replace.replace.api.top.annotation.Trigger > nextTriggers, Object executor )
            throws Throwable {

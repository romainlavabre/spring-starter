...
public class Delete implements DeleteEntry {
    ...
    protected void delete( Request request, Object subject, List< com.replace.replace.api.dynamic.annotation.Trigger > nextTriggers )
            throws Throwable {
        delete( request, subject, nextTriggers, null );
    }


    protected void delete( Request request, Object subject, List< com.replace.replace.api.dynamic.annotation.Trigger > nextTriggers, Object executor )
            throws Throwable {

package com.replace.replace.api.dynamic.kernel.trigger;
...
public class TriggerHandler {
    ...
    public class Trigger {
        ...
        private final List< com.replace.replace.api.dynamic.annotation.Trigger > triggers;
        ...
        public List< com.replace.replace.api.dynamic.annotation.Trigger > getTriggers() {
            return triggers;
        }
